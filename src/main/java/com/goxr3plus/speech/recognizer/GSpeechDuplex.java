...
public class GSpeechDuplex {
	...
	private SpeechRecInteractor.MainInter mainProg;
	 ...
	 */
	public GSpeechDuplex(String API_KEY, SpeechRecInteractor.MainInter main) {
	...
	public void setMainInterface(SpeechRecInteractor.MainInter main){
		this.mainProg=main;
	}
...
//				try {
//					mainProg.startFridayRec();
//				} catch (Exception e){
//					System.out.println(e.getClass().getSimpleName() + "error restarting friday rec after finishing down channel");
//				}
			}
		};
	...
	private void openHttpsPostConnection(String murl , TargetDataLine mtl , int sampleRate) {
		...
		try {
			...
			ex.printStackTrace();
			System.out.println("IO Exception from GSpeech");
			if(mainProg != null){
				mainProg.startFridayRec();
			}
		}  catch (Exception e){
			e.printStackTrace();
			System.out.println("Exception from GSpeech");
			if(mainProg != null){
				mainProg.startFridayRec();
			}
	}
